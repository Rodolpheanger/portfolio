    ...
    >
      ...
      <div className="flex w-full flex-col items-center justify-center gap-4 sm:gap-8">
        ...
        >
          ...
          <button className="w-1/2 scale-100 bg-secondary px-4 py-2 font-montserrat text-xs transition duration-500 hover:scale-105 hover:bg-tertiary hover:text-white sm:max-w-xs md:px-8 md:py-4 md:text-base">
            Télécharger
          </button>
        </Link>
      </div>
